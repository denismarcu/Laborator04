package contactsmanager.lab04.eim.systems.cs.pub.ro.contactsmanager;
...
public class ContactsManagerActivity extends AppCompatActivity {
            ...
            switch (view.getId()) {
                case R.id.show_hide_additional_fields:
                    if (additionalFields.getVisibility() == View.VISIBLE) {
                        showButton.setText(getResources().getString(R.string.show_additional_fields));
                        additionalFields.setVisibility(View.INVISIBLE);
                    }
                    else if (additionalFields.getVisibility() == View.INVISIBLE) {
                        showButton.setText(getResources().getString(R.string.hide_additional_fields));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showButton = (Button) findViewById(R.id.show_hide_additional_fields);
